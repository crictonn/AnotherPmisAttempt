...
public class ImplProjectDependency extends DelegatingProjectDependency {
    ...
    /**
     * Creates a project dependency on the project at path ":impl:local-storage"
     */
    public Impl_LocalStorageProjectDependency getLocalStorage() { return new Impl_LocalStorageProjectDependency(getFactory(), create(":impl:local-storage")); }
